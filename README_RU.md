...
- опциональных интеграций с DI через отдельные пакеты;
...
- Расширение интеграций для дополнительных DI-провайдеров помимо [**Microsoft.Extensions.DependencyInjection**](https://www.nuget.org/packages/Microsoft.Extensions.DependencyInjection/).
